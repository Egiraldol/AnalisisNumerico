...
def bisection_method(a: float, b: float, Tol: float, Niter: int, Fun: str, png_filename: str = "Imgs/bisection_method/bisection_plot.png", html_filename: str = "Imgs/bisection_method/bisection_plot.html"):
